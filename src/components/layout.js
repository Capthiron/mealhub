  ...
  render() {
    ...
    if (location.pathname === rootPath) {
      header = (
          ...
          <p>An open source blog for food recipes that are quick and easy to prepare. Perfect for any workaholic with a lack of time... <span role={"img"} aria-label={"Emoji Story"}>⏳💼➡🏠👩‍🍳👍</span></p>
        </div>
      )
    } else {
      header = (
